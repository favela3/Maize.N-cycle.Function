...
#I think this is based on the read count? so if the read cound is 100000, then at a 1% there should be at least 10000 reads for the OTU. I think I may make it 001% I really want to remove singletons not micobes that are. 
...
# I think it's okay, they are just in a different order...

#Here is where filtering would need to take place to effectively alter the microbail communtiy. It seems like the 224 is where the teosinte start
#THis Chunck of code creates the maize exclusize data
# OTU_norm<-OTU_norm[-c(224:294),]
# env1<-env1[-c(224:294),]
